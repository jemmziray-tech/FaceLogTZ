...
- **Interactive Voice Assistant:** Integrated `pyttsx3` offline Text-to-Speech engine to provide real-time audio confirmation and student greetings.
...
- **`face_recognition`** - Deep learning models for generating 128-dimension facial encodings.
